...
_Материал основан на открытых судебных данных и личном опыте автора. Все выводы в тексте носят оценочный характер и отражают субъективное мнение автора. Автор не делает утверждений о недобросовестности или злоупотреблении правом, если это прямо не установлено вступившими в силу судебными актами. Автор также не утверждает наличие сговора или иных противоправных действий со стороны истцов, их представителей или суда, если это прямо не установлено вступившими в силу судебными актами. По части дел обжалование продолжается, и правовая оценка обстоятельств не является окончательной._
...
И вот в этот момент российское правосудие показывает себя с лучшей стороны. Спокойно. С достоинством. И с удивительной способностью жить в процессуальной реальности, где разница между мультяшным 2D-рисунком и фотографией человека в костюме на странице «Праздники под ключ» оказывается не такой уж принципиальной.

Когда люди говорят «ну что такого, поставили пару картинок на сайт», обычно они представляют максимум письмо с просьбой удалить контент. В моем случае все вышло тоньше: на сайте были фотографии аниматоров в костюмах, а иски, претензии и решения пошли как за использование охраняемых 2D-рисунков персонажей и товарных знаков. Именно эта подмена плоскостей, а уже потом расходы на «фиксацию нарушения» по `10 000 рублей` в каждом деле, и стала для меня демонстрацией того, как в России работает интеллектуальное право, когда оно встречается с маленьким бизнесом и старым сайтом.
...
Но в той процессуальной логике, которую я увидел в своих делах, это почти не имеет значения. Если нашелся правообладатель, его представитель, скриншоты, сравнение с мультяшным персонажем, договор на «фиксацию» и арбитражный шаблон, дальше включается очень рациональная механика взыскания.
...
| Дело | Истец | Сумма до | Сумма после |
|---|---|---:|---:|
| `А45-39161/2025` | ИП Днепровский | `70 360 руб.` | `30 156 руб.` |
| `А45-39132/2025` | ООО «САК Мельница» | `120 360 руб.` | н/д |
| `А45-42946/2025` | АО «СТС» | `120 360 руб.` | н/д |
| `А45-39342/2025` | АО «Аэроплан» | `120 356 руб.` | `60 156 руб.` |
...
## Масштаб истцов в открытых цифрах

Чтобы не было ощущения, что это спор маленького автора с гигантской безликой системой только на уровне эмоций, я посмотрел открытые данные по самим истцам. Метрики там разнородные: у юрлиц чаще доступны выручка и иногда оценка бизнеса, у ИП такой публичной бухгалтерской отчетности обычно нет, поэтому там приходится смотреть агрегированные данные по связанным бизнесам.

- ИП Днепровский А.В.: по открытым агрегаторам за `2024` год совокупная выручка связанных компаний и бизнесов, связанных с этим ИНН, оценивается примерно в `57,8 млн руб.`. Для самого ИП сопоставимой публичной бухгалтерской выручки я не нашел.
- ООО «САК Мельница»: по данным открытых профилей, выручка за `2024` год около `206,5 млн руб.`, оценка бизнеса около `270,4 млн руб.`.
- АО «СТС»: в открытых профилях доступны данные бухгалтерской отчетности до `2021` года; там фигурирует выручка `23,1 млрд руб.` и оценка бизнеса около `40,5 млрд руб.`.
- АО «Аэроплан»: по открытым данным выручка на конец `2024` года указана на уровне `346,2 млн руб.`.

То есть картина простая: с одной стороны старый сайт маленькой студии праздников, с другой стороны компании и правообладатели, для которых даже десятки миллионов выручки не предел, а для `АО «СТС»` речь вообще идет о десятках миллиардов.

Источники:

- ИП Днепровский А.В. на Reputation: https://reputation.ru/inn/505015374080
- Днепровский А.В. на Rusprofile: https://www.rusprofile.ru/person/dneprovskiy-av-505015374080
- ООО «САК Мельница» на Saby: https://saby.ru/profile/7825124659-781101001
- АО «СТС» на Saby: https://saby.ru/profile/7707115217-775050001
- АО «Аэроплан» на РБК Компании: https://companies.rbc.ru/id/1057746600559-ao-aeroplan/
...
С точки зрения здравого смысла это выглядит не как возмещение необходимых издержек, а как повторяющийся процессуальный расход, который удобно прикладывать к каждому новому иску.
...
### 4. Почему для малого бизнеса это работает особенно болезненно
...
В решениях суды регулярно ссылаются на разумность, справедливость, соразмерность и законность. Моя оценка этой конструкции расходится с тем, как эти категории применяются в моих делах.
...
Иными словами, даже если реальный вред остается спорным, сама конструкция требований может быть признана достаточной при наличии предусмотренных законом формальных элементов.
...
Моя позиция здесь иная: такой подход выглядит для меня чрезмерно формализованным и довольно слабо связанным с той реальностью, где на сайте были именно фотографии услуги.
...
То есть о том, что на тебя подали иск, ты узнаешь не от государства как от организатора процесса, а от людей, которые уже предлагают свои услуги на фоне этой проблемы.
...
### 2. Очное присутствие в суде это не «нормальный разговор», а очень жесткий процессуальный формат

Есть популярная наивная мысль: «ну ладно, если что, приду в суд и объясню по-человечески».

Нет.

Очное присутствие в таком процессе воспринимается не как шанс на нормальный разговор, а как участие в очень жестком процессуальном формате, где:

- ты очень быстро понимаешь, что человеческий язык здесь вторичен;
...
- и при этом еще пытаться не выглядеть лишним человеком на фоне людей, которые этот формат крутят каждый день.

Именно это и ощущается унизительно.

Не потому, что суд не должен быть формальной процедурой. Формальность как раз бывает полезна. Унизительно другое: когда тебе очень быстро дают понять, что твои обычные слова и твоя человеческая логика здесь вторичны. Ты должен сначала пройти через языковой и поведенческий фильтр системы, и только потом, возможно, тебе дадут что-то договорить по существу.
...
И вот здесь ИИ, как ни странно, оказывается гуманнее системы. С ним хотя бы можно разговаривать на обычном языке, не подбирая каждую фразу под ритуал.

## Отдельный штрих к картине: один и тот же представитель по доверенности

Когда начинаешь разбирать несколько дел подряд не как случайный ответчик, а как человек с grep, папками и упрямством, начинает проступать еще одна деталь. В материалах разных дел повторяется один и тот же представитель истцов по доверенности. В этом тексте я буду обозначать ее как `Скотинова Н.Ю.`; ФИО изменено.

Я намеренно не использую реальные персональные данные в публичном тексте, хотя в судебных документах и на заверенных скриншотах они встречаются. Формально это публичный процессуальный контекст, но тащить полные данные в публикацию без необходимости я не вижу смысла. Для статьи достаточно того факта, что это один и тот же представитель, который регулярно всплывает в нескольких похожих историях.

И вот тут у обычного человека закономерно возникает неприятное ощущение повторяемости.

Не в том смысле, что я могу доказать какой-то «заговор». Не в том смысле, что суд установил существование специальной схемы. Этого я не утверждаю. Я лишь обратил внимание на повторяемость отдельных элементов в разных делах: схожие конструкции, сходные наборы документов и одного и того же представителя по доверенности. Я не могу утверждать, что это свидетельствует о какой-либо общей модели; это лишь наблюдение на основании нескольких дел и мое субъективное мнение.
...
- дальше из этого складывается повторяющийся набор процессуальных элементов.

И если ты сидишь с другой стороны стола, это воспринимается не как абстрактная теория защиты интеллектуальной собственности, а как очень практическая и повторяющаяся юридическая реальность.
...
То есть только по двум уже разобранным решениям получилось `90 312 руб.` взыскания. И именно поэтому для меня принципиально важны не только деньги, но и сам способ, которым фото услуги превращаются в объект нескольких самостоятельных судебных требований.
...
**Медиа в этом репозитории:** иллюстрации лежат в каталоге [`media/`](./media/). Ниже в Markdown указаны относительные пути `media/…` — так этот файл нормально открывается на GitHub. Для вставки на Хабр (или другой внешний редактор) после пуша подставьте абсолютный URL вида `https://raw.githubusercontent.com/<user>/<repo>/<ветка>/odin-sait-chetyre-iska/media/<имя_файла>`.
